            ...
            <div class="card mb-3">
                ...
                <div>
                  ...
                  <div class="card-text">
                    <div class="descripcion">
                        ...
                        <br>
                        <span>Categoria: {{$video->categoria->tipo}}</span>
                    </div>
                  </div>
                  <h4>
                ...
                <div class="mostrar-comentario">
                    ...
                    <div class="descripcion">
                        ...
                        @if(Auth::check() && ($comentario->users_id == Auth::user()->id || $comentario->video->users_id == Auth::user()->id))
                        <a class="btn btn-sm  btn-danger" href="{{route('comentario.delete', ['id' => $comentario->id])}}">
