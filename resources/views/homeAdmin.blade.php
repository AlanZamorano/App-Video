...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <a href="{{route('video.detailA', ['id' => $video->id])}}">
                <div class="videoH">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    ...
                    <a href="{{route('video.aceptado', ['id' => $video->id])}}">
                    <button class="btn btn-success me-2" type="button">Aceptar</button>
                </a>
                <a href="{{route('video.rechazado', ['id' => $video->id])}}">
                    <button class="btn btn-danger me-2" type="button">Rechazar</button>
                    </a>
                    @endif
